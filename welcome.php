		...
		<div class="container">
			<div class="row">
				<div class="col-md-7">
					...
					<a href="#" id="mehr" class="btn ghost btn-lg">Mehr erfahren</a>
				</div>
				<div class="col-md-5">
					...
					<form class="form-horizontal" action="" method="post" role="form">
					  ...
					  <div class="form-group">
					    <div class="col-sm-offset-2 col-sm-10">
					      <button type="submit" class="btn btn-primary">Registrieren</button><span> </span><a href="#" class="btn twitter"><i class="fa fa-twitter"></i> Mit Twitter Registrieren</a>
					    </div>
					  </div>
					  <div class="form-group">
					    <div class="col-sm-offset-2 col-sm-10">
					     <p>Du hast bereits ein Konto?<a href="#"> Hier anmelden</a></p>
					    </div>
					  </div>
					</form>
					</div>
